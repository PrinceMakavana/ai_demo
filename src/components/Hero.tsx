...
const Hero = ({ children }: HeroProps) => {
  ...
  const handleAnalyze = async () => {
    if (domain.trim()) {
      try {
        const data = await getDomainData({ domain_name: domain }).unwrap()
  ...
  return (
    <section className="bg-gradient-to-b from-queryosity-blue to-queryosity-dark text-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Optimize Your Website for AI Search</h1>
        <p className="text-xl mb-8">
          Discover how your website performs in AI search engines and get actionable insights to improve your
          visibility.
        </p>
        <div className="w-full max-w-3xl mx-auto mb-12 animate-fade-in" style={{ animationDelay: "0.4s" }}>
          <div className="flex flex-col md:flex-row gap-4">
            <Input
              ...
              className="text-base px-4 py-6 flex-grow text-black"
              value={domain}
